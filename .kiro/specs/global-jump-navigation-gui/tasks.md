...
- [ ] 1. Add text search to location search method
...
- [ ] 4. Create GlobalJumpControl component skeleton
...
- [ ] 5. Implement artifact type selector
...
- [ ] 6. Implement confidence threshold slider
  - Add range slider (0-1, step 0.1)
  - Display percentage value
  - Show only for object/face/place types
  - _Requirements: 3.1, 3.2, 3.3, 3.4, 3.5_

- [ ] 7. Implement navigation buttons and API calls
...
- [ ] 8. Implement cross-video navigation handling
...
- [ ] 9. Implement current match display
...
- [ ] 10. Implement form state preservation
...
- [ ] 12. Create Search page component
...
- [ ] 13. Implement search page navigation
...
- [ ] 15. Replace JumpNavigationControl with GlobalJumpControl
...
- [ ] 16. Handle form state from search page
...
- [ ] 20. Write GlobalJumpControl unit tests
